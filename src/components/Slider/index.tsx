...
const Silder: React.FC<SliderProps> = ({ data }) => {
    ...
    return (
        ...
        <div className='topBlock__slider slider' onMouseLeave={mouseUp} onTouchEnd={mouseUp} onMouseUp={mouseUp} onTouchStart={mouseDown} onMouseDown={mouseDown} onTouchMove={mouseMove} onMouseMove={mouseMove} >
